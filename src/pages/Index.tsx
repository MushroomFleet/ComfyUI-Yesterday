...
import { Workflow as WorkflowIcon, Wifi, WifiOff } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold">ComfyUI Workflow Runner</h1>
                <p className="text-sm text-muted-foreground">Execute workflows with real-time monitoring</p>
              </div>
            </div>
